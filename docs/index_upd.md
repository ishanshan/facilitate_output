...
### 04-25 [好奇带来奇妙旅程 · 笑来写作训练营结业手记](https://ishanshan.im/tool/selfedu/review_writingcourse_xl)
...
### 04-22 [希望人生更从容且有方向？试试这个小本子 ·「人生彩虹本」使用手记](https://ishanshan.im/tool/selfedu/tips_rainbowbook)

自从在朋友圈推荐过「人生彩虹本」后，陆续有朋友来询问我是如何使用的，尤其[《从迷茫焦虑到从容踏实，这两个月我干了啥？· 万字复盘》](https://ishanshan.im/selfedu/tool/review2021Q1)发出后，更多朋友来交流。

为了减少重复劳动，现把一些使用方法、心得和 FAQ 汇总到博客上并持续更新，供有需要的伙伴参考。如果你有疑问建议，欢迎留言交流：）

---

### 04-17 [不要评判某事好坏 · 杂记](https://ishanshan.im/selfedu/murmur/depend_on_your_goal)
...
### 04-13 [从迷茫焦虑到从容踏实，这两个月我干了啥？· 万字复盘](https://ishanshan.im/selfedu/tool/review2021Q1)
...
### 04-08 [启动新项目，如何设定项目目标 · 项目需求采集问题清单](https://ishanshan.im/tool/infoq_projectmanagement_pre)
...
### 04-03 [这座线上心理健身房，你，值得拥有](https://ishanshan.im/tool/selfedu/ebp_happiness)
...
### 03-31 [「输出实验室」玩法介绍&报名入口（长期有效）](https://ishanshan.im/community/selfedu/info_facilitate_output)
...
### 03-08 [我如何成为换头最快的1%？· 过去8个月的面容调整复盘](https://ishanshan.im/selfedu/tool/ReviewFacialGrowth)
...
### 04-04 [由“拥抱变化”引发的羞愧和反思 · 杂记](https://ishanshan.im/selfedu/murmur/TipsEmbraceChange)
...
### 08-27 [借时代便利，增父母安康 · 关爱家人行动清单](https://ishanshan.im/tool/TipsCare4Parents)
...
### 08-15 [这波内容付费平台，未来的困境和出路会在哪 · 杂记 ](https://road2strategypm.ishanshan.im/CONTENT/TipsEduSuperficialProductChallenge.html)
...
### 07-28 [如何带出和自己一样能干的团队 · 半年摸爬小记](https://ishanshan.im/selfedu/community/TipsBecomeTeamLeaderBasic)
...
### 07-21 [这样用七牛，插图优雅又省心 · MarkDown 码字发文最佳实践](https://ishanshan.im/tool/community/HbMarkdownImage)
...
### 07-15 [卡片助力输出， MarkDown + GitHub + LOFTER 有轻功](https://ishanshan.im/selfedu/tool/HbOutputOwetoCards)
...
### 04-28 [给文字工作者的 GitHub 上手攻略](https://ishanshan.im/tool/HbGitHubPre)
...
### 03-23 [实用但小众的 MarkDown 技巧 ](https://github.com/ishanshan/CollaborationGuide4Shaper/blob/master/CONTENT/HbMarkdownTrick.md)
...
类似的 MarkDown 技巧还有不少，为了方便你取用、共建，我汇总在 GitHub 上。期待你来 pull request 🙋🏻：
...
### 02-17 [你丁酉年的故事](https://ishanshan.im/selfedu/Review2017LunarCalendar.html)
...
### 02-14 [谢谢你给她的时光](https://ishanshan.im/murmur/Letter2XY4Year2017.html)
...
### 02-07 [Swing 吧！你的苦乐，swing 知道](https://ishanshan.im/selfedu/YouNeedSwing.html)

愿知识工作者如你，也欣闻归属。

## 2017

### 11-29 [跟王烁「老婆推」学记趣和爱 · 杂记](https://ishanshan.im/selfedu/TipsLiveAFascinatingLife.html)
...
### 11-23 [如果你也在天上挑妈妈 · 家书 000](https://ishanshan.im/murmur/LetterFamily000Baby)

如果你也在天上挑妈妈，可不可以，先看我一眼？

---

### 09-21 [友聚如何更有趣？· 杂记 ](https://github.com/ishanshan/CollaborationGuide4Shaper/blob/master/CONTENT/InfoQ4Icebreaking.md)
...
### 09-11 [体能 不能落 · 杂记](https://ishanshan.im/murmur/TipsEfficiencyMorningExercise)
...
### 04-12 [活动主持人如何快速进入状态？如何从源头避免编程初级错误？· 170311 见 @ZoomQuiet 小记](https://ishanshan.im/murmur/tool/LogMeetup170311ZqBJ)
...
### 03-01 [卡片助力输入输出，工具我选 WorkFlowy](https://ishanshan.im/selfedu/HbOutputOwetoWorkFlowy.html)
...
### 01-24 [用心写周报的同事，绩效不会太差](https://ishanshan.im/selfedu/TipsWeekly.html)
...
### 10-30 [想让生活不再满是工作？试试远距联想](https://ishanshan.im/murmur/TipsWorkHappier.html)
...
### 10-10 [和大 Boss 协同，你有什么秘诀？邮件先行。](https://ishanshan.im/selfedu/TipsCooperateWithBoss.html)
...
### 06-11 [我挺好，别担心 · 写在工作一周年边上](https://ishanshan.im/murmur/WorkFor1Year)
...
### 02-12 [GitHub 协作五大业余姿势](https://ishanshan.im/community/HbGitHubCooperate.html)
...
### 02-10 [命名用英文，烦恼少大半 · 团队文档命名指南](https://ishanshan.im/community/HbDocName.html)
...
### 02-07  [改变我玩耍习惯的 10 场活动](https://ishanshan.im/community/IdxActivity)
...
### 01-26  [讲座控，控住你的人生 · 学习自传（一）](https://ishanshan.im/selfedu/community/SelfEduOwetoJZK)
...
### 06-02  [入职第一天，我失眠了](https://ishanshan.im/selfedu/NewLifeinOMC.html)
